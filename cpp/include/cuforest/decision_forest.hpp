...
#include <cuforest/detail/device_initialization.hpp>
#include <cuforest/detail/forest.hpp>
#include <cuforest/detail/index_type.hpp>
#include <cuforest/detail/infer.hpp>
...
struct decision_forest {
   ...
   * @param node_id_mapping Mapping to use to convert cuForest's internal node ID
   * into Treelite's node ID. Only relevant when predict_type == infer_kind::leaf_id
