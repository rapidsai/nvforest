...
#include <cuforest/detail/cpu_introspection.hpp>
#include <cuforest/detail/forest.hpp>
#include <cuforest/detail/index_type.hpp>
#include <cuforest/detail/infer_kernel/cpu.hpp>
...
#include <cuforest/detail/raft_proto/gpu_support.hpp>
 ...
 * references the 8 specialization variants compiled in standard cuForest. */
CUFOREST_INFER_ALL(extern template, raft_proto::device_type::cpu, 0)
CUFOREST_INFER_ALL(extern template, raft_proto::device_type::cpu, 1)
CUFOREST_INFER_ALL(extern template, raft_proto::device_type::cpu, 2)
CUFOREST_INFER_ALL(extern template, raft_proto::device_type::cpu, 3)
CUFOREST_INFER_ALL(extern template, raft_proto::device_type::cpu, 4)
CUFOREST_INFER_ALL(extern template, raft_proto::device_type::cpu, 5)
CUFOREST_INFER_ALL(extern template, raft_proto::device_type::cpu, 6)
CUFOREST_INFER_ALL(extern template, raft_proto::device_type::cpu, 7)
CUFOREST_INFER_ALL(extern template, raft_proto::device_type::cpu, 8)
CUFOREST_INFER_ALL(extern template, raft_proto::device_type::cpu, 9)
CUFOREST_INFER_ALL(extern template, raft_proto::device_type::cpu, 10)
CUFOREST_INFER_ALL(extern template, raft_proto::device_type::cpu, 11)
