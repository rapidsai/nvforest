...
#include <cuforest/detail/gpu_introspection.hpp>
#include <cuforest/detail/index_type.hpp>
#include <cuforest/detail/infer_kernel/gpu.cuh>
#include <cuforest/detail/postprocessor.hpp>
#include <cuforest/detail/raft_proto/buffer.hpp>
#include <cuforest/detail/raft_proto/ceildiv.hpp>
...
#include <cuforest/detail/raft_proto/padding.hpp>
 ...
 * references the 8 specialization variants compiled in cuForest. */
CUFOREST_INFER_ALL(extern template, raft_proto::device_type::gpu, 0)
CUFOREST_INFER_ALL(extern template, raft_proto::device_type::gpu, 1)
CUFOREST_INFER_ALL(extern template, raft_proto::device_type::gpu, 2)
CUFOREST_INFER_ALL(extern template, raft_proto::device_type::gpu, 3)
CUFOREST_INFER_ALL(extern template, raft_proto::device_type::gpu, 4)
CUFOREST_INFER_ALL(extern template, raft_proto::device_type::gpu, 5)
CUFOREST_INFER_ALL(extern template, raft_proto::device_type::gpu, 6)
CUFOREST_INFER_ALL(extern template, raft_proto::device_type::gpu, 7)
