...
#include <cuforest/detail/raft_proto/device_setter.hpp>
...
namespace cuforest::detail::device_initialization {
...
CUFOREST_INITIALIZE_DEVICE(extern template, 0)
CUFOREST_INITIALIZE_DEVICE(extern template, 1)
CUFOREST_INITIALIZE_DEVICE(extern template, 2)
CUFOREST_INITIALIZE_DEVICE(extern template, 3)
CUFOREST_INITIALIZE_DEVICE(extern template, 4)
CUFOREST_INITIALIZE_DEVICE(extern template, 5)
CUFOREST_INITIALIZE_DEVICE(extern template, 6)
CUFOREST_INITIALIZE_DEVICE(extern template, 7)
CUFOREST_INITIALIZE_DEVICE(extern template, 8)
CUFOREST_INITIALIZE_DEVICE(extern template, 9)
CUFOREST_INITIALIZE_DEVICE(extern template, 10)
CUFOREST_INITIALIZE_DEVICE(extern template, 11)
