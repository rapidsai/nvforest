 ...
 */
#pragma once
#include <cuforest/detail/evaluate_tree.hpp>
#include <cuforest/detail/gpu_introspection.hpp>
#include <cuforest/detail/index_type.hpp>
#include <cuforest/detail/infer_kernel/shared_memory_buffer.cuh>
 ...
 * measurable performance benefit. In cuForest, we compile for all
...
CUFOREST_KERNEL void __launch_bounds__(MAX_THREADS_PER_BLOCK, MIN_BLOCKS_PER_SM) infer_kernel(
  forest_t forest,
