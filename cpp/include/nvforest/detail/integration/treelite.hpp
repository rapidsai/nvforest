...
struct treelite_traversal_node : public traversal::traversal_node<TREELITE_NODE_ID_T> {
...
template <traversal::forest_order order, typename lambda_t>
...
template <traversal::forest_order order, typename iter_t, typename lambda_t>
...
template <traversal::forest_order order, typename T, typename lambda_t>
