...
find_and_configure_raft(VERSION          ${CUFOREST_MIN_VERSION_raft}
      FORK             rapidsai
      PINNED_TAG       ${rapids-cmake-checkout-tag}
      EXCLUDE_FROM_ALL ${CUFOREST_EXCLUDE_RAFT_FROM_ALL}
      # When PINNED_TAG above doesn't match cuforest,
      # force local raft clone in build directory
      # even if it's already installed.
      CLONE_ON_PIN     ${CUFOREST_RAFT_CLONE_ON_PIN}
      USE_RAFT_STATIC  ${CUFOREST_USE_RAFT_STATIC}
      NVTX             ${NVTX}
      )
