...
function(find_and_configure_raft)
  set(oneValueArgs VERSION FORK PINNED_TAG EXCLUDE_FROM_ALL USE_RAFT_STATIC COMPILE_LIBRARY
                   CLONE_ON_PIN NVTX
  )
  ...
  # We need to set this each time so that on subsequent calls to cmake the raft-config.cmake
  # re-evaluates the RAFT_NVTX value
  ...
  rapids_cpm_find(
    ...
    OPTIONS "BUILD_TESTS OFF" "BUILD_PRIMS_BENCH OFF" "BUILD_CAGRA_HNSWLIB OFF"
...
# Change pinned tag here to test a commit in CI To use a different RAFT locally, set the CMake
# variable CPM_raft_SOURCE=/path/to/local/raft
find_and_configure_raft(
  ...
  # When PINNED_TAG above doesn't match cuforest, force local raft clone in build directory even if
