...
auto static const TRAVERSAL_RESULTS =
  std::vector<std::pair<traversal::forest_order, treelite_traversal_results>>{
    // Order: ABDEFGCHIJKLMNOPQRSTUVWYZX
    std::make_pair(traversal::forest_order::depth_first,
    ...
    std::make_pair(traversal::forest_order::breadth_first,
                   treelite_traversal_results{
    ...
    std::make_pair(traversal::forest_order::layered_children_together,
                   treelite_traversal_results{
    ...
    std::make_pair(traversal::forest_order::layered_children_segregated,
                   treelite_traversal_results{
...
template <traversal::forest_order order>
...
{
  auto feature_or_output = get_feature_or_outputs<traversal::forest_order::depth_first>();
  auto depths            = get_depths<traversal::forest_order::depth_first>();
...
{
  auto feature_or_output = get_feature_or_outputs<traversal::forest_order::breadth_first>();
  auto depths            = get_depths<traversal::forest_order::breadth_first>();
